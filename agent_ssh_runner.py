    ...
    messages: list[dict[str, Any]] = [
        {
            ...
            "content": (
                ...
                "Hard rules:\n"
                "- If user says OBC/open boundary/开放边界, you MUST call ssh_band with boundary='obc' and set N.\n"
                "- If user requests 'overlay/compare with PBC/对比PBC', set overlay_pbc=true (still boundary='obc').\n"
                "- If user says PBC/periodic boundary/周期边界, use boundary='pbc'.\n"
                "- If user asks 'clean then run', call clean_out first, then ssh_band.\n"
